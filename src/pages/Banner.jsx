                        ...
                        <div className="carousel-caption">
                            <div className="p-3" style={{ maxWidth: '900px', margin: '40px auto' }}>
                                ...
                                <p className="mb-5 fs-5">
                                    Providing exceptional care for your pets with cutting-edge medical technology
                                    and compassionate service. Your pet's health and happiness are our priority.
                                </p>
